package com.example.parkingsystem.utils.adapters;
...
import com.example.parkingsystem.classes.BookedSlotKey;
...
//            cancelBooking = (Button) itemView.findViewById(R.id.cancelBooking);
        }
    }
}
